 ...
 *
 */
public final class Bee2SignedInfo extends DOMStructure implements SignedInfo {
    ...
    private static final Logger LOG = System.getLogger(Bee2SignedInfo.class.getName());
     ...
     */
    public Bee2SignedInfo(CanonicalizationMethod cm, SignatureMethod sm,
     ...
     */
    public Bee2SignedInfo(Element siElem, XMLCryptoContext context, Provider provider)
        ...
        Element smElem = DOMUtils.getNextSiblingElement(cmElem,
                                                        "SignatureMethod",
                                                        XMLSignature.XMLNS);
        signatureMethod = Bee2SignatureMethod.unmarshal(smElem);

        boolean secVal = Bee2Reference.secureValidation(context);
        ...
        refList.add(new Bee2Reference(refElem, context, provider));
        ...
        throws MarshalException
    {
        ...
        for (Reference reference : references) {
            ((Bee2Reference)reference).marshal(siElem, dsPrefix, context);
        }
