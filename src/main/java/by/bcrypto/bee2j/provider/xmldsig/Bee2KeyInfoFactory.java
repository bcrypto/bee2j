 ...
 *
 */
public final class Bee2KeyInfoFactory extends KeyInfoFactory {

    public Bee2KeyInfoFactory() { }
    ...
    public KeyValue newKeyValue(PublicKey key)  throws KeyException {
        ...
        if ("DSA".equals(algorithm)) {
            return new Bee2KeyValue.DSA((DSAPublicKey) key);
        } else if ("RSA".equals(algorithm)) {
            return new Bee2KeyValue.RSA((RSAPublicKey) key);
        } else if ("EC".equals(algorithm)) {
            return new Bee2KeyValue.EC((ECPublicKey) key);
        } else if ("Bign".equals(algorithm)) {
            return new Bee2KeyValue.Bign((BignPublicKey) key);
        } else {
