 ...
 *
 */
public final class Bee2URIDereferencer implements URIDereferencer {

    static final URIDereferencer INSTANCE = new Bee2URIDereferencer();

    private Bee2URIDereferencer() {
