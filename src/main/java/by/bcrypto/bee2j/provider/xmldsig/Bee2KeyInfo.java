 ...
 *
 */
public final class Bee2KeyInfo extends DOMStructure implements KeyInfo {
     ...
     */
    public Bee2KeyInfo(List<? extends XMLStructure> content, String id) {
        if (content == null) {
     ...
     */
    public Bee2KeyInfo(Element kiElem, XMLCryptoContext context,
                      Provider provider)
        ...
        while (firstChild != null) {
            if (firstChild.getNodeType() == Node.ELEMENT_NODE) {
                ...
                if ("X509Data".equals(localName) && XMLSignature.XMLNS.equals(namespace)) {
                    ...
                    content.add(Bee2KeyValue.unmarshal(childElem));
