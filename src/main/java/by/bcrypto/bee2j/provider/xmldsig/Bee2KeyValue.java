 ...
 *
 */
public abstract class Bee2KeyValue<K extends PublicKey> extends DOMStructure implements KeyValue {

    private static final String XMLDSIG_11_XMLNS
        = "http://www.w3.org/2009/xmldsig11#";
    private final K publicKey;

    public Bee2KeyValue(K key) throws KeyException {
        if (key == null) {
     ...
     */
    public Bee2KeyValue(Element kvtElem) throws MarshalException {
    ...
    static final class RSA extends Bee2KeyValue<RSAPublicKey> {
    ...
    static final class DSA extends Bee2KeyValue<DSAPublicKey> {
    ...
    static final class EC extends Bee2KeyValue<ECPublicKey> {
    ...
    static final class Unknown extends Bee2KeyValue<PublicKey> {
