...
public class BignWithBash512Signature extends SignatureSpi {
    ...
    protected byte[] engineSign() {
        ...
        var hashResult = bee2.bashHash(hash, 256, byte_data, byte_data.length);
        IntByReference pointer = new IntByReference(128);
        if (bee2.bignOidToDER(oid_der, pointer, OidConstants.Bash512) != 0)
            return null;
